...
Der zweite Kennwert beschreibt die Wirksamkeit der Schätzung des Standardfehlers und berechnet sich aus dem Verhältnis zwischen dem mittleren Standardfehler aus einer Bedingung und der Standardabweichung der Regressionskoeffizienten über alle 1000 Replikationen dieser Bedingung \citep{hooglandboosma1998robustness, mcneish2014analyzing}. Die Formel zur Berechnung sieht wie folgt aus:
\begin{equation}
...
Bei der Berechnung der relativen Abweichung ergab sich in allen Bedingungen eine relative Abweichung die kleiner als 5\% ist. 

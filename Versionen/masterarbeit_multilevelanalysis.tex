...
Bis jetzt wurden nur Modelle miteinander verglichen und herausgefunden, dass ein unkorreliertes \textit{Random Intercept and Slope} Modell am meisten Varianz aufklärt. Es stellt sich dann aber die Frage, wie viel Varianz denn eigentlich durch dieses Modell aufgeklärt wird. Dazu gibt es bei der normalen linearen Regression das $R^2$.

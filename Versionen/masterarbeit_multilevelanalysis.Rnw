...
\end{split}	
\end{equation} 
Bei dieser Darstellung handelt es sich um die hierarchische Schreibweise der Gleichung, da die einzelnen Gleichungen gleich dem dazugehörigen Level zugeordnet werden. 

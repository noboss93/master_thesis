...
Auf der linken Seite von Abbildung \ref{fig:disaggregation} sieht man die Regressionsgerade, die durch die Disagregation entsteht. Auf den ersten Blick scheint 

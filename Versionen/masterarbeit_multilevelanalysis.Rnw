...
Ebenfalls lässt sich anhand der Abbildung erahnen, dass das \textit{Random Intercept and Slope} Modell besser zu den Daten passt, dies bestätigt sich ebenfalls bei Begutachtung des Residuenplots in Abbildung \ref{fig:resid_rism}. 

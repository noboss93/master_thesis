...
Beispielsweise kann man erkennen, dass die Klassen eins und fünf eher tiefere und die Klassen zwei und drei eher höhere Punktzahlen erreichen.
Ebenfalls kann man beobachten, dass die Geraden besser zu den Daten passen. Dies wird um einiges klarer, wenn man die Residuenplots des hierarchischen linearen und des nomralen linearen Modells vergleicht.

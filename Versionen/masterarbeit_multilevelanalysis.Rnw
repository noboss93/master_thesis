...
Dieser ökologische Fehlschluss lässt sich relativ einfach an unserem Beispiel erklären. Betrachtet man die Regressionsgerade in Abbildung \ref{fig:aggregiert}, könnte man daraus schlussfolgern, dass ein höhere Anzahl an gelöster Übungsaufgaben mit einer tieferen durchschnittlich erreichten Punktzahl zusammenhängt.  
